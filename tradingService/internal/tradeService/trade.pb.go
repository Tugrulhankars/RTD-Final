...
const (
	TradeType_TRADE_TYPE_UNSPECIFIED TradeType = 0 // default
...
// Trade oluşturma cevabı
type CreateTradeResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Message       string                 `protobuf:"bytes,1,opt,name=message,proto3" json:"message,omitempty"`
	TradeId       int32                  `protobuf:"varint,2,opt,name=trade_id,json=tradeId,proto3" json:"trade_id,omitempty"` // opsiyonel: yeni trade'in ID'si
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
var file_protos_trade_proto_goTypes = []any{
	(TradeType)(0),              // 0: tradeService.TradeType
	(*CreateTradeRequest)(nil),  // 1: tradeService.CreateTradeRequest
	(*CreateTradeResponse)(nil), // 2: tradeService.CreateTradeResponse
}
var file_protos_trade_proto_depIdxs = []int32{
	0, // 0: tradeService.CreateTradeRequest.type:type_name -> tradeService.TradeType
	1, // 1: tradeService.TradeService.CreateTrade:input_type -> tradeService.CreateTradeRequest
	2, // 2: tradeService.TradeService.CreateTrade:output_type -> tradeService.CreateTradeResponse
